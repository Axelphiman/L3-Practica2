...
"""def openBinaryTreeGUI():
    ...
    text_box = Entry(windowBinaryTree,font=("Consolas",12),text = 'pille', textvariable= cadenaArbol,width="30")
    text_box.place(x=90,y= 80)
    #Propiedades del botón
    button_send = Button(windowBinaryTree, text="Agregar", command=addTree(cadenaArbol),font=("Consolas",10), bg="#005e35", fg="#ffffff", width="14",height="2")
